...
set output "../graphs/lossRates_size.svg"
set title "Loss rates"
set xlabel "lossrate"
set ylabel "Size"

stats "lossRates_size.dat" u 2 #ta 2 je ktory stlpec sa ma použiť na rátanie
...
"lossRates_size.dat" u 1:2 title "Delays" w l lt 8 #tu 2 si zmen ked chceš ako Y vykresliť iný stlpec